...
describe("Components", () => {
  describe("BaseComponent", () => {
    describe(
      ...
      EmitterMixinBehavior.test.bind(this, new testComponent("nav"))
    );
    describe(
      PubSubBehavior.describe(),
      PubSubBehavior.test.bind(this, new testComponent("main"))
    );
    xdescribe(
      DomEventBehavior.describe(),
      DomEventBehavior.test.bind(this, new testComponent("input"))
    );
  ...
  beforeEach(() => {
    let instances = [];
    viewA = new testComponent(document.createElement("figure"), {
      swerve: true
    });
