...
export default class NotificationList extends Component {
    ...
    bindSubscriptions () {
        ...
        this.listenTo(this.collection, Evt.COLLECTION_ADD, this.onCollectionAdd.bind(this));
        this.listenTo(this.collection, Evt.COLLECTION_REMOVE, this.onCollectionAdd.bind(this));
        return this;
    }
    ...
    render () {
        if (!this.isMounted()) {
            let parsed = jst.compileToDOM(this.template, this.model.serialize(), {'notification': jst.getFromDOM('notification')});
